...
const translations = {
  en: {
    ...
    "nav.qualityOverview": "Accreditation Readiness",
    ...
    "dashboard.attentionDescription": "Tests that are approved but still have no report — generate the report so the work isn't left unfinished.",
    "dashboard.attentionEmpty": "Nothing waiting — every approved test has its report.",
    "dashboard.attentionGenerate": "Generate report",
    "dashboard.completionTitle": "Tests to complete",
    "dashboard.completionDescription": "Tests whose testing is not finished yet — the technicians' work queue.",
    "dashboard.completionEmpty": "All tests are done — nothing left to run.",
    "dashboard.completionOpen": "Open test",
    ...
    ,"save.conflict": "Not saved — someone else edited at the same time"
    ,"save.reload": "Reload"
    ,"save.retry": "Retry"
    ,"test.batch": "Batch"
  ...
  sq: {
    ...
    "nav.qualityOverview": "Gatishmëria",
    ...
    "dashboard.attentionTitle": "Kërkojnë vëmendje",
    "dashboard.attentionDescription": "Teste të miratuara që ende nuk kanë raport — gjeneroni raportin që puna të mos mbetet përgjysmë.",
    "dashboard.attentionEmpty": "Asgjë në pritje — çdo test i miratuar e ka raportin.",
    "dashboard.attentionGenerate": "Gjenero raportin",
    "dashboard.completionTitle": "Teste për t'u përfunduar",
    "dashboard.completionDescription": "Teste testimi i të cilave nuk ka përfunduar ende — radha e punës së teknikëve.",
    "dashboard.completionEmpty": "Të gjitha testet janë kryer — nuk ka mbetur asgjë.",
    "dashboard.completionOpen": "Hap testin",
    ...
    ,"save.conflict": "Nuk u ruajt — dikush tjetër ndryshoi në të njëjtën kohë"
    ,"save.reload": "Rifresko"
    ,"save.retry": "Provo përsëri"
    ,"test.batch": "Grupi"
    ,"test.required": "Afati"
