...
function supabaseServer() {
  ...
  // The service role only. The register refuses anonymous callers now, so
  // falling back to the publishable key would not weaken this job so much as
  // silence it: it would read nothing and report a confident nothing to do —
  // the worst possible answer from a job whose purpose is noticing what has
  // been missed.
